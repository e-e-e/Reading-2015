...
$(document).ready(function() {
	...
	var options = {
		...
		title_text: '<span style="font-family:\'UnionAUnderline\'">Benjamin Forster</span> Reading ('+site+') <span style="font-family:\'UnionAUnderline\'">2015</span><br><sub style="font-family:\'UnionA\';font-size:40%">an online performance from 4 - 6 pm today</sub>',
